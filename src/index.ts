 ...
 */
export const equivalent = <U1 extends URN<string, string, unknown, unknown, unknown>, U2 extends URN<string, string, unknown, unknown, unknown>>(u1: U1, u2: U2): boolean =>
  u1.nid.toLowerCase() === u2.nid.toLowerCase() && normalizePercentCase(u1.nss) === normalizePercentCase(u2.nss)
